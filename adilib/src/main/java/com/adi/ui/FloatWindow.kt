...
class FloatWindow(private val mContext: Context) {
    private val wm: WindowManager = mContext.getSystemService(WINDOW_SERVICE) as WindowManager
    var wmParams: WindowManager.LayoutParams = WindowManager.LayoutParams()
    ...
    fun show() {
        if (mContentView != null) {
            ...
            wmParams.alpha = 0.6f // 1.0为完全不透明，0.0为完全透明
